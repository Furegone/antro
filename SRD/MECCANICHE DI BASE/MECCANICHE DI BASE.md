...
- Quando **prendi una carta di dominio aggiuntiva**: puoi scegliere una carta di dominio aggiuntiva al tuo livello o inferiore o dai domini della tua classe. Se hai multiclassato, puoi invece selezionare una carta al tuo livello o inferiore alla metà del tuo livello dal dominio multiclass che hai scelto.
...
| Brocciere                | Agilità    | Mischia       | d4+4 fisico | A una mano | **Deviante**: Quando vieni attaccato, puoi segnare uno Slot Armatura per ottenere un bonus alla tua Evasione pari al tuo Punteggio Armatura disponibile contro l'attacco. |
...
|  15  | **Pietravalore**                       | Puoi attaccare questa pietra a un'armatura che non ha già una caratteristica. L'armatura ottiene la seguente caratteristica: Resistente: Prima di segnare il tuo ultimo slot Armatura, tira un d6. Con un risultato di 6, riduci la gravità di una soglia senza segnare uno slot Armatura.                                                        |
|  16  | **Grimaldello**                        | Quando usi questa chiave per aprire una porta chiusa, ottieni vantaggio nel tiro di Finezza.                                                                                                                                                                                                                                                      |
|  17  | **Prisma Arcano**                      | Posiziona questo prisma in un luogo a tua scelta e attivalo. Tutti gli alleati nel raggio di Vicino ottengono un bonus di +1 ai loro tiri di Incantesimi. Mentre è attivato, il prisma non può essere spostato. Una volta disattivato, non può essere attivato di nuovo fino al tuo prossimo riposo lungo.                                        |
|  18  | **Ricetta Pozione di Stamina Minore**  | Come mossa di riposo, puoi usare l'osso di una creatura per creare una Pozione di Stamina Minore.                                                                                                                                                                                                                                                 |
|  19  | **Ricetta Pozione di Salute Minore**   | Come mossa di riposo, puoi usare una fiala di sangue per creare una Pozione di Salute Minore.                                                                                                                                                                                                                                                     |
...
|  23  | **Custodelore**                        | Puoi memorizzare il nome e i dettagli di un massimo di tre creature ostili in questo libro. Ottieni un bonus di +1 ai tiri di azione contro quelle creature.                                                                                                                                                                                      |
|  24  | **Ricetta Fiala di Fumo Oscuro**       | Come mossa di riposo, puoi segnare uno Stress per creare una Fiala di Fumo Oscuro.                                                                                                                                                                                                                                                                |
|  25  | **Pietrasangue**                       | Puoi attaccare questa pietra a un'arma che non ha già una caratteristica. L'arma ottiene la seguente caratteristica: Brutale: Quando ottieni il valore massimo su un dado danno, tira un dado danno aggiuntivo.                                                                                                                                   |
|  26  | **Pietragrande**                       | Puoi attaccare questa pietra a un'arma che non ha già una caratteristica. L'arma ottiene la seguente caratteristica: Potente: In caso di attacco riuscito, tira un dado danno aggiuntivo e scarta il risultato più basso.                                                                                                                         |
|  27  | **Deltaplano**                         | Durante una caduta, puoi segnare uno Stress per dispiegare questo piccolo paracadute e planare in sicurezza a terra.                                                                                                                                                                                                                              |
...
|  34  | **Scatola di Molti Beni**              | Una volta per riposo lungo, puoi aprire questa piccola scatola e tirare un d12. Con un risultato di 1–6, è vuota. Con un risultato di 7–10, contiene un consumabile comune casuale. Con un risultato di 11–12, contiene due consumabili comuni casuali.                                                                                           |
|  35  | **Amuleto Airblade**                   | Puoi attaccare questo amuleto a un'arma con un raggio Mischia. Tre volte per riposo, puoi attivare l'amuleto e attaccare un bersaglio nel raggio di Vicino.                                                                                                                                                                                       |
...
|  37  | **Catena del Paragone**                | Come mossa di riposo, puoi meditare su un ideale o un principio a te caro e concentrare la tua volontà in questa catena. Una volta per riposo lungo, puoi spendere una Speranza per tirare un d20 come tuo Speranza Die per i tiri che si allineano direttamente con quel principio.                                                              |
|  38  | **Amuleto Elusivo**                    | Una volta per riposo lungo, puoi attivare questo amuleto per diventare Hidden finché non ti muovi. Mentre sei Hidden in questo modo, rimani invisibile anche se un avversario si sposta dove normalmente ti vedrebbe.                                                                                                                             |
|  39  | **Medaglione Speranzakeeper**          | Durante un riposo lungo, se hai 6 Speranza, puoi spendere una Speranza per infondere questo medaglione con la tua abbondante risolutezza. Quando hai 0 Speranza, puoi usare il medaglione per ottenere immediatamente una Speranza. Il medaglione deve essere re-infuso prima di poter essere usato di nuovo in questo modo.                      |
|  40  | **Sacco Infinito**                     | Quando riponi oggetti in questo sacco, sono tenuti in una dimensione tascabile che non esaurisce mai lo spazio. Puoi recuperare un oggetto in qualsiasi momento.                                                                                                                                                                                  |
|  41  | **Reliquia Stride**                    | Ottieni un bonus di +1 alla tua Agilità. Puoi portare solo una reliquia.                                                                                                                                                                                                                                                                          |
|  42  | **Reliquia Bolster**                   | Ottieni un bonus di +1 alla tua Forza. Puoi portare solo una reliquia.                                                                                                                                                                                                                                                                            |
|  43  | **Reliquia Control**                   | Ottieni un bonus di +1 alla tua Finezza. Puoi portare solo una reliquia.                                                                                                                                                                                                                                                                          |
|  44  | **Reliquia Attune**                    | Ottieni un bonus di +1 alla tua Istinto. Puoi portare solo una reliquia.                                                                                                                                                                                                                                                                          |
|  45  | **Reliquia Charm**                     | Ottieni un bonus di +1 alla tua Presenza. Puoi portare solo una reliquia.                                                                                                                                                                                                                                                                         |
|  46  | **Reliquia Enlighten**                 | Ottieni un bonus di +1 alla tua Conoscenza. Puoi portare solo una reliquia.                                                                                                                                                                                                                                                                       |
|  47  | **Reliquia Honing**                    | Ottieni un bonus di +1 a un Esperienza a tua scelta. Puoi portare solo una reliquia.                                                                                                                                                                                                                                                              |
...
|  49  | **Stivali Lakestrider**                | Puoi camminare sulla superficie dell'acqua come se fosse terreno soffice.                                                                                                                                                                                                                                                                         |
...
|  54  | **Gemma di Potenza**                   | Gemma di Potenza Puoi attaccare questa gemma a un'arma, permettendoti di usare la tua Forza quando fai un attacco con quell'arma.                                                                                                                                                                                                                 |
...
|  60  | **Cintura dell'Unità**                 | Una volta per sessione, puoi spendere 5 Speranza per condurre un Tiro di Tag Team con tre PG invece di due.                                                                                                                                                                                                                                       |
### CONSUMABILI
...
| :--: | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|  1   | **Pozione Stride**                 | Ottieni un bonus di +1 al tuo prossimo tiro di Agilità.                                                                                                                                                                                           |
|  2   | **Pozione Bolster**                | Ottieni un bonus di +1 al tuo prossimo tiro di Forza.                                                                                                                                                                                             |
|  3   | **Pozione Control**                | Ottieni un bonus di +1 al tuo prossimo tiro di Finezza.                                                                                                                                                                                           |
|  4   | **Pozione Attune**                 | Ottieni un bonus di +1 al tuo prossimo tiro di Istinto.                                                                                                                                                                                           |
|  5   | **Pozione Charm**                  | Ottieni un bonus di +1 al tuo prossimo tiro di Presenza.                                                                                                                                                                                          |
|  6   | **Pozione Enlighten**              | Ottieni un bonus di +1 al tuo prossimo tiro di Conoscenza.                                                                                                                                                                                        |
|  7   | **Pozione di Salute Minore**       | Libera 1d4 PF.                                                                                                                                                                                                                                    |
|  8   | **Pozione di Stamina Minore**      | Libera 1d4 Stress.                                                                                                                                                                                                                                |
|  9   | **Veleno Grindletooth**            | Puoi applicare questo veleno a un'arma che infligge danno fisico per aggiungere un d6 al tuo prossimo tiro danno con quell'arma.                                                                                                                  |
|  10  | **Foglie Varik**                   | Puoi mangiare queste foglie accoppiate per ottenere immediatamente 2 Speranza.                                                                                                                                                                    |
|  11  | **Fiala di Moondrip**              | Quando bevi il contenuto di questa fiala, puoi vedere nell'oscurità totale fino al tuo prossimo riposo.                                                                                                                                           |
|  12  | **Scheggia Arcano Instabile**      | Puoi fare un tiro di Finezza per lanciare questa scheggia a un gruppo di avversari nel raggio di Lontano. I bersagli contro cui hai successo subiscono 1d20 di danno magico.                                                                      |
|  13  | **Pozione di Stabilità**           | Puoi bere questa pozione per scegliere una mossa di riposo aggiuntiva.                                                                                                                                                                            |
|  14  | **Veleno Grindletooth Migliorato** | Puoi applicare questo veleno a un'arma che infligge danno fisico per aggiungere un d8 al tuo prossimo tiro danno con quell'arma.                                                                                                                  |
...
|  17  | **Radice Saltante**                | Mangia questa radice per saltare fino a un raggio Lontano una volta senza dover tirare.                                                                                                                                                           |
|  18  | **Polvere Snap**                   | Segna uno Stress e libera un PF.                                                                                                                                                                                                                  |
|  19  | **Pozione di Salute**              | Libera 1d4+1 PF.                                                                                                                                                                                                                                  |
|  20  | **Pozione di Stamina**             | Libera 1d4+1 Stress.                                                                                                                                                                                                                              |
...
|  23  | **Pergamena di Replicazione**      | Toccando questa pergamena a un'altra, puoi copiare perfettamente il contenuto della seconda pergamena. Una volta usata, questa pergamena diventa carta comune.                                                                                    |
|  24  | **Scheggia Arcano Migliorata**     | Puoi fare un tiro di Finezza per lanciare questa scheggia a un gruppo di avversari nel raggio di Lontano. I bersagli contro cui hai successo subiscono 2d20 di danno magico.                                                                      |
|  25  | **Pozione Stride Maggiore**        | Ottieni un bonus di +1 alla tua Agilità fino al tuo prossimo riposo.                                                                                                                                                                              |
|  26  | **Pozione Bolster Maggiore**       | Ottieni un bonus di +1 alla tua Forza fino al tuo prossimo riposo.                                                                                                                                                                                |
|  27  | **Pozione Control Maggiore**       | Ottieni un bonus di +1 alla tua Finezza fino al tuo prossimo riposo.                                                                                                                                                                              |
|  28  | **Pozione Attune Maggiore**        | Ottieni un bonus di +1 alla tua Istinto fino al tuo prossimo riposo.                                                                                                                                                                              |
|  29  | **Pozione Charm Maggiore**         | Ottieni un bonus di +1 alla tua Presenza fino al tuo prossimo riposo.                                                                                                                                                                             |
|  30  | **Pozione Enlighten Maggiore**     | Ottieni un bonus di +1 alla tua Conoscenza fino al tuo prossimo riposo.                                                                                                                                                                           |
|  31  | **Sangue dello Yorgi**             | Puoi bere questo sangue per scomparire da dove sei e riapparire immediatamente in un punto che puoi vedere nel raggio di Very Lontano.                                                                                                            |
|  32  | **Pozione Segreta di Homet**       | Dopo aver bevuto questa pozione, il prossimo attacco riuscito che fai ha un successo critico.                                                                                                                                                     |
|  33  | **Saliva Redthorn**                | Puoi applicare questa saliva a un'arma che infligge danno fisico per aggiungere un d12 al tuo prossimo tiro danno con quell'arma.                                                                                                                 |
|  34  | **Pietracanale**                   | Puoi usare questa pietra per prendere un incantesimo o un grimoire dal tuo riserva, usarlo una volta e restituirlo al tuo riserva.                                                                                                                |
...
|  36  | **Pastiglia Acida**                | Questa pasta corrode pareti e altre superfici in lampi luminosi.                                                                                                                                                                                  |
|  37  | **Bagliore Speranzahold**          | Quando usi questo bagliore, gli alleati nel raggio di Vicino tirano un d6 quando spendono una Speranza. Con un risultato di 6, ottengono l'effetto di quella Speranza senza spenderla. Il bagliore dura fino alla fine della scena.               |
|  38  | **Scheggia Arcano Maggiore**       | Puoi fare un tiro di Finezza per lanciare questa scheggia a un gruppo di avversari nel raggio di Lontano. I bersagli contro cui hai successo subiscono 4d20 di danno magico.                                                                      |
...
|  41  | **Linfa dell'Albero del Sole**     | Consuma questa linfa per tirare un d6. Con un risultato di 5–6, libera 2 PF. Con un risultato di 2–4, libera 3 Stress. Con un risultato di 1, vedi attraverso il velo della morte e torni cambiato, ottenendo una cicatrice.                      |
|  42  | **Veleno Dripfang**                | Una creatura che consuma questo veleno subisce 8d10 di danno magico diretto.                                                                                                                                                                      |
|  43  | **Pozione di Salute Maggiore**     | Libera 1d4+2 PF.                                                                                                                                                                                                                                  |
|  44  | **Pozione di Stamina Maggiore**    | Libera 1d4+2 Stress.                                                                                                                                                                                                                              |
|  45  | **Muschio Ogre**                   | Puoi usare questo muschio per impedire a chiunque di tracciarti con mezzi comuni o magici fino al tuo prossimo riposo.                                                                                                                            |
...
|  48  | **Tè di Dragonbloom**              | Puoi bere questo tè per scatenare un attacco di alito di fuoco. Fai un tiro di Istinto contro tutti gli avversari di fronte a te nel raggio di Vicino. I bersagli contro cui hai successo subiscono d20 di danno fisico usando la tua Competenza. |
|  49  | **Seme Ponte**                     | Delle viti spesse crescono dalla tua posizione a un punto a tua scelta nel raggio di Lontano, permettendoti di arrampicarti su o attraverso di esse. Le viti si dissipano al tuo prossimo riposo breve.                                           |
|  50  | **Linfa Soporifera**               | Puoi bere questa pozione per addormentarti per una notte intera. Liberi tutto lo Stress al risveglio.                                                                                                                                             |
|  51  | **Festa di Xuria**                 | Puoi mangiare questo pasto per liberare tutti gli PF e lo Stress e guadagnare 1d4 Speranza.                                                                                                                                                       |
...
|  54  | **Pozione Crescente**              | Puoi bere questa pozione per raddoppiare la tua taglia finché non scegli di abbandonare questa forma o il tuo prossimo riposo. Mentre sei in questa forma, hai un bonus di +2 a Forza e un bonus di +1 alla tua Competenza.                       |
|  55  | **Pietra della Conoscenza**        | Se muori mentre tieni questa pietra, un alleato può prendere una carta dal tuo dotazione per posizionarla nel loro dotazione o riserva. Dopo che hanno preso questa conoscenza, la pietra si sgretola.                                            |
|  56  | **Muschio Dolce**                  | Puoi consumare questo muschio durante un riposo per liberare 1d10 PF o 1d10 Stress.                                                                                                                                                               |
|  57  | **Globo Accecante**                | Puoi attivare questo globo per creare un lampo di luce brillante. Tutti i bersagli nel raggio di Vicino diventano Vulnerabili finché non segnano PF.                                                                                              |
...
|  60  | **Stardrop**                       | Puoi usare questo stardrop per evocare una grandinata di comete che infligge 8d20 di danno fisico a tutti i bersagli nel raggio di Very Lontano.                                                                                                  |
### ORO
L'oro è una misurazione astratta di quanta ricchezza ha un personaggio, ed è misurato in **manciate**, **sacchi** e **casse**, con 10 manciate per 1 sacco e 10 sacchi per 1 cassa. Quando hai segnato tutti gli slot in una categoria e ottieni un'altra ricompensa in quella categoria, segna uno slot nella categoria successiva e libera tutti gli slot in quella attuale. 
